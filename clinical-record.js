...
// Header + left rail wired to real data (migration 113 / "112" tables, club-scoped,
// gated to medical role by RLS). Defensive throughout: any table that returns empty
// (no data or RLS denial) renders "—" / hides its section instead of breaking.
// Tabs, KPIs, body map and the right-hand panels stay on the preview's static markup
// for now — wired in later steps.
(function () {
  'use strict';
