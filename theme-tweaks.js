...
const _PERSISTED_SETTINGS = (() => {
  try {
    return JSON.parse(localStorage.getItem("cm-settings.v1") || "{}");
  } catch {
    return {};
  }
})();
...
function applyTokens(theme, accent, radius, density, sidebarHue) {
  ...
  const wipe = ["--cm-accent", "--cm-accent-hover", "--cm-accent-press", "--cm-fg-on-accent", "--cm-side-item-active-bg", "--cm-side-item-active-fg", "--cm-side-accent", "--cm-side-bg", "--cm-r-2", "--cm-r-3", "--cm-r-4", "--cm-r-5", "--cm-r-6", "--cm-page-pad-y", "--cm-page-pad-x"];
...
function ThemeTweaks() {
  ...
  React.useEffect(() => {
    ...
    try {
      localStorage.setItem("cm-settings.v1", JSON.stringify({
        ...
        radius: t.radius,
        density: t.density,
        sidebarHue: t.sidebarHue
      }));
    } catch {}
  }, [t.theme, t.accent, t.radius, t.density, t.sidebarHue]);
  const swatchesForTheme = theme => Object.entries(ACCENT_SWATCHES[theme]).map(([k, v]) => v.swatch);
  ...
  return /*#__PURE__*/React.createElement(TweaksPanel, {
    ...
    onChange: swatch => {
      ...
      const entry = Object.entries(ACCENT_SWATCHES[t.theme]).find(([_, v]) => JSON.stringify(v.swatch) === JSON.stringify(swatch));
      if (entry) setTweak("accent", entry[0]);
    }
  })), t.theme === "hybrid" || t.theme === "dark" ? /*#__PURE__*/React.createElement(TweakSection, {
    label: "Sidebar tone"
  }, /*#__PURE__*/React.createElement(TweakRadio, {
    label: "Hue",
    value: t.sidebarHue,
  ...
  })) : null, /*#__PURE__*/React.createElement(TweakSection, {
    label: "Shape"
  }, /*#__PURE__*/React.createElement(TweakRadio, {
    label: "Corners",
    value: t.radius,
...
(function mount() {
  const target = document.getElementById("tweaks-root") || document.body.appendChild(Object.assign(document.createElement("div"), {
    id: "tweaks-root"
  }));
  ...
  root.render(/*#__PURE__*/React.createElement(ThemeTweaks, null));
})();
