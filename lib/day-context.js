...
(function () {
  ...
  window.cmResolveDayContext = async function (dateStr, teamId, clubId) {
    const out = { microcycle:null, md:'', start_time:null, duration:null, estimated_rpe:null, opponent:null, rival:null, home_away:null, hasEvent:false, dayOff:false, dayOffPlayerIds:[] };
