 ...
 * @property {{ id: 'player_name'|'position'|'session_date'|'md_code'|'microcycle'|'rival' }[]} [dimensions]  grouping/label fields (no aggregation); empty ⇒ row/X defaults to player_name
