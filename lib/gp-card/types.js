 ...
 * @property {null|{ baseline: 'position'|'match'|'md'|'self'|'mc'|'squad', method?: 'avg'|'wavg'|'zscore', refWindow?: ({ type: 'season' }|{ type: 'lastN', days: number }|null), opts?: { topN?: number, mdLookback?: number }, refMcId?: (string|null) }} comparison
