...
const _ACCENT = {
  light: {
    neutral: {
      ...
      tokens: {
        "--cm-accent": "#0A0A0A",
        "--cm-accent-hover": "#1F1F1F",
        "--cm-accent-press": "#000",
        "--cm-accent-soft": "#F4F4F2",
        "--cm-fg-on-accent": "#fff"
      }
    },
    green: {
    ...
    blue: {
      ...
      tokens: {
        "--cm-accent": "#2563EB",
        "--cm-accent-hover": "#1D4ED8",
        "--cm-accent-press": "#1E40AF",
    ...
    violet: {
      ...
      tokens: {
        "--cm-accent": "#7C3AED",
        "--cm-accent-hover": "#6D28D9",
        "--cm-accent-press": "#5B21B6",
        "--cm-accent-soft": "#F5F3FF",
        "--cm-fg-on-accent": "#fff"
      }
    },
    gold: {
      ...
      tokens: {
        "--cm-accent": "#A87C2A",
        "--cm-accent-hover": "#8C6520",
        "--cm-accent-press": "#75531B",
        "--cm-accent-soft": "#FAF3E2",
        "--cm-fg-on-accent": "#fff"
      }
    }
  },
  dark: {
    neutral: {
      ...
      tokens: {
        "--cm-accent": "#FAFAFA",
        "--cm-accent-hover": "#E5E5E5",
        "--cm-accent-press": "#fff",
        "--cm-accent-soft": "rgba(255,255,255,0.06)",
        "--cm-fg-on-accent": "#0A0A0A"
      }
    },
    green: {
      hue: "#22C55E",
      ...
      tokens: {
        "--cm-accent": "#22C55E",
        "--cm-accent-hover": "#16A34A",
        "--cm-accent-press": "#15803D",
        "--cm-accent-soft": "rgba(34,197,94,0.10)",
        "--cm-fg-on-accent": "#0A0A0A"
      }
    },
    blue: {
      ...
      tokens: {
        ...
        "--cm-accent-press": "#1D4ED8",
        "--cm-accent-soft": "rgba(59,130,246,0.10)",
        "--cm-fg-on-accent": "#fff"
      }
    },
    violet: {
      ...
      tokens: {
        "--cm-accent": "#A78BFA",
        "--cm-accent-hover": "#8B5CF6",
        "--cm-accent-press": "#7C3AED",
        "--cm-accent-soft": "rgba(167,139,250,0.10)",
        "--cm-fg-on-accent": "#0A0A0A"
      }
    },
    gold: {
      ...
      tokens: {
        "--cm-accent": "#C9A84C",
        "--cm-accent-hover": "#A87C2A",
        "--cm-accent-press": "#8B6520",
        "--cm-accent-soft": "rgba(201,168,76,0.12)",
        "--cm-fg-on-accent": "#0A0A0A"
      }
    }
  },
  hybrid: {
    neutral: {
      ...
      tokens: {
        ...
        "--cm-accent-soft": "#F4F4F2",
        "--cm-fg-on-accent": "#fff",
        "--cm-side-item-active-bg": "rgba(255,255,255,0.06)",
        "--cm-side-item-active-fg": "#fff",
        "--cm-side-accent": "#fff"
      }
    },
    green: {
      ...
      tokens: {
        ...
        "--cm-accent-soft": "#ECFDF5",
        "--cm-fg-on-accent": "#fff",
        "--cm-side-item-active-bg": "rgba(34,197,94,0.10)",
        "--cm-side-item-active-fg": "#4ADE80",
        "--cm-side-accent": "#4ADE80"
      }
    },
    blue: {
      hue: "#2563EB",
      ...
      tokens: {
        ...
        "--cm-accent-soft": "#EFF6FF",
        "--cm-fg-on-accent": "#fff",
        "--cm-side-item-active-bg": "rgba(59,130,246,0.14)",
        "--cm-side-item-active-fg": "#60A5FA",
        "--cm-side-accent": "#60A5FA"
      }
    },
    violet: {
      hue: "#7C3AED",
      ...
      tokens: {
        ...
        "--cm-accent-soft": "#F5F3FF",
        "--cm-fg-on-accent": "#fff",
        "--cm-side-item-active-bg": "rgba(167,139,250,0.14)",
        "--cm-side-item-active-fg": "#A78BFA",
        "--cm-side-accent": "#A78BFA"
      }
    },
    gold: {
      hue: "#A87C2A",
      ...
      tokens: {
        ...
        "--cm-accent-soft": "#FAF3E2",
        "--cm-fg-on-accent": "#fff",
        "--cm-side-item-active-bg": "rgba(201,168,76,0.16)",
        "--cm-side-item-active-fg": "#E5C875",
        "--cm-side-accent": "#E5C875"
      }
    }
  }
};
...
function _apply(s) {
  ...
  // wipe
  const wipe = ["--cm-accent", "--cm-accent-hover", "--cm-accent-press", "--cm-accent-soft", "--cm-fg-on-accent", "--cm-side-item-active-bg", "--cm-side-item-active-fg", "--cm-side-accent", "--cm-side-bg", "--cm-r-2", "--cm-r-3", "--cm-r-4", "--cm-r-5", "--cm-r-6", "--cm-density-pad"];
...
function initSettings() {
  ...
  const defaults = window.__CM_TWEAK_DEFAULTS || {
    theme: "light",
    accent: "neutral"
  };
...
const NotificationToast = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ti ti-bell cm-toast-icon"
  }), /*#__PURE__*/React.createElement("div", {
    className: "cm-toast-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cm-toast-title"
  }, notif.title), notif.body && /*#__PURE__*/React.createElement("div", {
    className: "cm-toast-sub"
  }, notif.body)), /*#__PURE__*/React.createElement("button", {
    className: "cm-toast-x",
    onClick: e => {
      e.stopPropagation();
      onDismiss();
    }
...
const BillingPanel = () => {
  ...
  React.useEffect(() => {
    window.getClub && window.getClub().then(c => {
      setClub(c);
      setLoading(false);
    });
  }, []);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "sd-section-h"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-section-l"
  }, "Workspace subscription")), /*#__PURE__*/React.createElement("div", {
    className: "sd-section-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-billing-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-billing-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "sd-row-label"
  }, "Plan"), /*#__PURE__*/React.createElement("span", {
    className: "sd-billing-val"
  }, loading ? '…' : plan || '—')), /*#__PURE__*/React.createElement("div", {
    className: "sd-billing-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "sd-row-label"
  }, "Monthly amount"), /*#__PURE__*/React.createElement("span", {
    className: "sd-billing-val"
  }, loading ? '…' : amount ? `$${amount}` : '—')), /*#__PURE__*/React.createElement("div", {
    className: "sd-billing-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "sd-row-label"
  }, "Next billing date"), /*#__PURE__*/React.createElement("span", {
    className: "sd-billing-val"
  }, loading ? '…' : next ? new Date(next).toLocaleDateString([], {
    month: 'long',
    day: 'numeric',
    year: 'numeric'
  }) : '—')), /*#__PURE__*/React.createElement("div", {
    ...
    className: "sd-billing-val",
    style: {
      color: status === 'active' ? 'var(--cm-success)' : 'var(--cm-fg-muted)'
    }
  }, loading ? '…' : status || '—'))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 14px',
      borderTop: '1px solid var(--cm-border-soft)'
    }
  ...
  }, "Ver detalle completo ", /*#__PURE__*/React.createElement("i", {
...
const SettingsDrawer = ({
  ...
  const Row = ({
    ...
    className: "sd-row-sub"
  }, sub) : null), /*#__PURE__*/React.createElement("div", {
    className: "sd-row-c"
  }, children));
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, SD_CSS), /*#__PURE__*/React.createElement("div", {
    className: `sd-overlay ${open ? "is-open" : ""}`,
    onClick: onClose
  }), /*#__PURE__*/React.createElement("aside", {
    className: `sd-drawer ${open ? "is-open" : ""}`,
    role: "dialog",
    "aria-label": "Settings"
    ...
    className: "sd-sub"
  }, "Appearance \xB7 workspace \xB7 account"))), /*#__PURE__*/React.createElement("button", {
    className: "sd-x",
    onClick: onClose,
    "aria-label": "Close"
  }, /*#__PURE__*/React.createElement("i", {
    ...
    key: id,
    className: `sd-tab ${tab === id ? "is-on" : ""}`,
    onClick: () => setTab(id)
  }, /*#__PURE__*/React.createElement("i", {
    className: `ti ${icon}`
  }), label))), /*#__PURE__*/React.createElement("div", {
    className: "sd-body"
  }, tab === "appearance" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Section, {
    label: "Theme",
    hint: "How the chrome looks across the app."
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-tiles"
  }, ["light", "dark", "hybrid"].map(t => /*#__PURE__*/React.createElement("button", {
    key: t,
    className: `sd-tile ${s.theme === t ? "is-on" : ""}`,
    onClick: () => set({
      theme: t,
      accent: _ACCENT[t][s.accent] ? s.accent : "green"
    })
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-tile-pv",
    style: {
      background: themeBg(t),
      borderColor: themeBorder(t)
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-tile-pv-bar",
    style: {
      background: t === "dark" ? "rgba(255,255,255,0.08)" : t === "hybrid" ? "rgba(255,255,255,0.06)" : "#EFEFED"
    }
  }), /*#__PURE__*/React.createElement("div", {
    className: "sd-tile-pv-c",
    style: {
      background: t === "dark" ? "#161616" : "#fff",
      borderColor: themeBorder(t)
    }
  })), /*#__PURE__*/React.createElement("div", {
    className: "sd-tile-label"
  }, /*#__PURE__*/React.createElement("span", null, t === "light" ? "Light" : t === "dark" ? "Dark" : "Hybrid"), s.theme === t ? /*#__PURE__*/React.createElement("i", {
    className: "ti ti-check"
  }) : null))))), /*#__PURE__*/React.createElement(Section, {
    label: "Accent",
    hint: "Used for primary buttons, active nav, and focus rings."
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-swatches"
  }, swatchesForTheme.map(([key, v]) => /*#__PURE__*/React.createElement("button", {
    key: key,
    ...
    className: "sd-swatch-hue",
    style: {
      background: v.hue
    }
  }), /*#__PURE__*/React.createElement("span", {
    className: "sd-swatch-name"
  }, key))))), s.theme !== "light" ? /*#__PURE__*/React.createElement(Section, {
    label: "Sidebar tone"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-chips"
  }, [{
    ...
    key: o.v,
    className: `sd-chip ${s.sidebarHue === o.v ? "is-on" : ""}`,
    onClick: () => set({
      sidebarHue: o.v
    })
  }, o.l)))) : null, /*#__PURE__*/React.createElement(Section, {
    label: "Density",
    hint: "Affects vertical padding inside cards & tables."
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-chips"
  }, [{
    v: "compact",
    ...
    key: o.v,
    className: `sd-chip ${s.density === o.v ? "is-on" : ""}`,
    onClick: () => set({
      density: o.v
    })
  }, o.l)))), /*#__PURE__*/React.createElement(Section, {
    label: "Corners"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-chips"
  }, [{
    ...
    key: o.v,
    className: `sd-chip ${s.radius === o.v ? "is-on" : ""}`,
    onClick: () => set({
      radius: o.v
    })
  }, o.l)))), /*#__PURE__*/React.createElement(Section, {
    ...
    className: "sd-reset-confirm"
  }, /*#__PURE__*/React.createElement("span", null, "Reset all appearance settings?"), /*#__PURE__*/React.createElement("button", {
    className: "sd-reset-yes",
    onClick: () => {
  ...
  }), "Reset to workspace defaults"))), tab === "notifications" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Section, {
    label: "In-app alerts",
    hint: "Shown as badges and banners inside the app."
  }, [{
    key: "alertInjury",
    label: "Injury reported",
    sub: "Badge on the Physio nav item"
  }, {
    key: "alertTask",
    label: "Task assigned to me",
    sub: "Badge on the Tasks nav item"
  }, {
    key: "alertSession",
    label: "Session published",
    sub: "Shown in Hub activity feed"
  }].map(({
    key,
    label,
    sub
    ...
    role: "switch",
    "aria-checked": !!(s.notif && s.notif[key]),
    ...
    label: "Email digest",
    hint: "Requires email delivery to be configured by the workspace admin."
  }, [{
    key: "emailWeekly",
    ...
    key: "emailInjury",
    label: "Injury alerts",
    sub: "Immediate — for medical staff"
  }].map(({
    key,
    label,
    sub
  ...
  }), "Email delivery is not yet configured for this workspace. Preferences are saved for when it is."))), tab === "account" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Section, {
    label: "Signed in as"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-account-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sd-account-avatar"
  }, profile ? (profile.full_name || profile.email || '?')[0].toUpperCase() : '?'), /*#__PURE__*/React.createElement("div", null, profile?.full_name && /*#__PURE__*/React.createElement("div", {
    className: "sd-row-label"
  }, profile.full_name), /*#__PURE__*/React.createElement("div", {
    className: "sd-row-sub"
  ...
  }, profile?.role || '')))), /*#__PURE__*/React.createElement(Section, {
    label: "Session"
  }, /*#__PURE__*/React.createElement("button", {
    className: "sd-reset sd-signout",
    onClick: async () => {
  ...
  }), "Sign out"))), tab === "billing" && /*#__PURE__*/React.createElement(BillingPanel, null)), /*#__PURE__*/React.createElement("footer", {
    className: "sd-foot"
  }, /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("i", {
    className: "ti ti-cloud"
  }), "Saved to cloud & this device"))));
};
const SD_CSS = `
...
function SettingsHost() {
  ...
  React.useEffect(() => {
    ...
    window.sb.auth.getSession().then(({
      ...
      window.sb.from('profiles').select('settings, notification_settings').eq('id', uid).single().then(({
        data: row
      }) => {
        if (!row) return;
        const sbSettings = {
      ...
      window.sb.from('notifications').select('id', {
        count: 'exact',
        head: true
      }).eq('user_id', uid).eq('read', false).then(({
        count
      }) => {
      ...
      channelRef.current = window.sb.channel('cm-notif-' + uid).on('postgres_changes', {
        event: 'INSERT',
        schema: 'public',
        table: 'notifications',
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SettingsDrawer, {
    open: open,
    ...
    className: "cm-notif-stack"
  }, notifPopups.map(n => /*#__PURE__*/React.createElement(NotificationToast, {
    key: n._popupId,
    notif: n,
    onDismiss: () => dismissPopup(n._popupId)
  }))));
}
(function mount() {
  initSettings();
  ...
  ReactDOM.createRoot(target).render(/*#__PURE__*/React.createElement(SettingsHost, null));
  document.addEventListener("click", e => {
    const t = e.target.closest("[data-open-settings]");
    if (t) {
      e.preventDefault();
      window.openCMSettings && window.openCMSettings();
    }
  });
})();
