...
(function () {
  ...
  var DICT = {
    ...
    "pr.tier3.meta": { en: "Up to 75 athletes · native GPS integrations", es: "Hasta 75 atletas · integraciones GPS nativas", pt: "Até 75 atletas · integrações GPS nativas" },
    ...
    "pr.f.nogps": { en: "No GPS / Catapult integration", es: "Sin integración GPS / Catapult", pt: "Sem integração GPS / Catapult" },
    ...
    "pr.faq.q5": { en: "Do I need separate accounts for Catapult or StatSports?", es: "¿Necesito cuentas separadas para Catapult o StatSports?", pt: "Preciso de contas separadas para Catapult ou StatSports?" },
    "pr.faq.a5": { en: "No — ClavaMetrics connects to your existing Catapult or StatSports account via OAuth on Profesional and Full tiers. We sync sessions automatically; no CSV exports needed.", es: "No — ClavaMetrics se conecta a tu cuenta de Catapult o StatSports por OAuth en los planes Profesional y Full. Sincronizamos las sesiones automáticamente; sin exportar CSV.", pt: "Não — o ClavaMetrics se conecta à sua conta do Catapult ou StatSports via OAuth nos planos Profesional e Full. Sincronizamos as sessões automaticamente; sem exportar CSV." },
