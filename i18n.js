...
(function () {
  ...
  var DICT = {
    ...
    "pr.f.alliniciacion": { en: "Everything in <strong>Free</strong>", es: "Todo lo de <strong>Free</strong>", pt: "Tudo do <strong>Free</strong>" },
    ...
    "pr.f.allbasico": { en: "Everything in <strong>Basic</strong>", es: "Todo lo de <strong>Basic</strong>", pt: "Tudo do <strong>Basic</strong>" },
    ...
    "pr.f.allprofesional": { en: "Everything in <strong>Professional</strong>", es: "Todo lo de <strong>Professional</strong>", pt: "Tudo do <strong>Professional</strong>" },
    ...
    "pr.mix.p": { en: "You don't pay one fixed plan per club — each category picks its own tier. The Sub-14 stays free while the senior squad runs on Professional. Your bill reflects exactly what each squad uses.", es: "No pagas un plan fijo por club — cada categoría elige su propio plan. La Sub-14 sigue gratis mientras la primera usa Professional. Tu factura refleja exactamente lo que usa cada equipo.", pt: "Você não paga um plano fixo por clube — cada categoria escolhe seu próprio plano. O Sub-14 fica grátis enquanto o time principal usa o Professional. Sua fatura reflete exatamente o que cada equipe usa." },
    ...
    "pr.ent.f.onboarding": { en: "Dedicated onboarding", es: "Onboarding dedicado", pt: "Onboarding dedicado" },
    ...
    "pr.faq.a1": { en: "You register one club workspace, then assign a tier to each category from the Admin panel. The Sub-14 can stay on Free while the senior squad runs on Professional. You only pay for the categories that need paid features, billed monthly or annually as one consolidated invoice.", es: "Registras un espacio de club y después asignas un plan a cada categoría desde el panel de Admin. La Sub-14 puede quedar en Free mientras la primera usa Professional. Solo pagas por las categorías que necesitan funciones pagas, facturadas mensual o anualmente en una factura consolidada.", pt: "Você registra um espaço de clube e depois atribui um plano a cada categoria pelo painel de Admin. O Sub-14 pode ficar no Free enquanto o time principal usa o Professional. Você só paga pelas categorias que precisam de recursos pagos, faturadas mensal ou anualmente numa fatura consolidada." },
    ...
    "pr.faq.a3": { en: "Every paid tier comes with a 14-day trial, no card required. The Free tier is free forever for categories under 15 athletes.", es: "Cada plan pago incluye 14 días de prueba, sin tarjeta. El plan Free es gratis para siempre para categorías de menos de 15 atletas.", pt: "Cada plano pago inclui 14 dias de teste, sem cartão. O plano Free é grátis para sempre para categorias com menos de 15 atletas." },
    ...
    "pr.faq.a5": { en: "Export a CSV from your GPS or tracking provider and upload it — ClavaMetrics turns it into dashboards and analysis. CSV import is available from the Basic tier up.", es: "Exportá un CSV desde tu proveedor de GPS o tracking y subilo — ClavaMetrics lo convierte en dashboards y análisis. La importación CSV está disponible desde el plan Basic.", pt: "Exporte um CSV do seu provedor de GPS ou tracking e faça upload — a ClavaMetrics o transforma em dashboards e análises. A importação CSV está disponível a partir do plano Basic." },
