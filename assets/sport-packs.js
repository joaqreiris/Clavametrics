...
(function () {
  ...
  const FOOTBALL_POSITIONS = {
    ...
    aliases: {
      ...
      'ATTACKING MIDFIELDER':'CAM', 'ATTACKING MID':'CAM', MCO:'CAM', MEDIAPUNTA:'CAM', ENGANCHE:'CAM', 'MEDIA PUNTA':'CAM', 'MEDIA-PUNTA':'CAM',
      ...
      // teniendo 'LATERAL DERECHO' a dos líneas de acá. El normalizador quita acentos y
      // pasa a mayúsculas, pero NO toca los guiones: por eso van las dos formas.
      'LATERAL ESQUERDO':'LB', 'LATERAL ESQ':'LB', 'LATERAL-ESQUERDO':'LB',
      'LATERAL DIREITO':'RB', 'LATERAL DIR':'RB', 'LATERAL-DIREITO':'RB',
      'ZAGUEIRO CENTRAL':'CB', 'PRIMEIRO ZAGUEIRO':'CB', 'SEGUNDO ZAGUEIRO':'CB',
      'PRIMEIRO VOLANTE':'CDM', 'VOLANTE DE MARCACAO':'CDM', 'CABECA DE AREA':'CDM',
      'SEGUNDO VOLANTE':'CM', 'MEIA CENTRAL':'CM', 'MEIO-CAMPISTA':'CM', 'MEIO CAMPISTA':'CM', 'MEIO-CAMPO':'CM',
      'MEIA ATACANTE':'CAM', 'MEIA-ATACANTE':'CAM', 'MEIA OFENSIVO':'CAM', 'MEIA ARMADOR':'CAM', 'ARMADOR':'CAM',
      'PONTA ESQUERDA':'LW', 'PONTA-ESQUERDA':'LW',
      'PONTA DIREITA':'RW', 'PONTA-DIREITA':'RW',
      CENTROAVANTE:'CF', 'CENTRO-AVANTE':'CF', 'ATACANTE CENTRAL':'CF', 'ATACANTE DE AREA':'CF', 'HOMBRE DE AREA':'CF',
      'SEGUNDO ATACANTE':'SS',
  ...
  const PACKS = {
    ...
    basketball: {
      ...
      i18n:      { 'shell.nav.match-reports':          'shell.nav.game_reports',
                   ...
                   'squad.dominant_foot':              'squad.dominant_hand',
                   'planner.field':                    'planner.court' },
