 ...
 *
 * Programmatic:
 *   CM_I18N.t("key", { name:"Joaco", count:3 })
 *   CM_I18N.setLang("es")           // persists (local + cloud hook)
 *   CM_I18N.current                 // "es"
 *   CM_I18N.ready.then(() => ...)   // resolves once first locale is applied
 ...
 *   4. IP geolocation         -> CM_I18N.setGeoCountry("AR")  (from an edge fn header)
...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent =
      ...
      "border:1px solid var(--cm-border,#e3e8e5);border-radius:12px;box-shadow:var(--cm-shadow-3,0 18px 40px -12px rgba(0,0,0,.25));padding:6px;}" +
