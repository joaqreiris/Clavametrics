...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      /* modal */
      '.dplg-back{position:fixed;inset:0;background:rgba(8,10,12,.62);-webkit-backdrop-filter:blur(6px); backdrop-filter:blur(6px);z-index:1100;display:none;align-items:center;justify-content:center;padding:20px}',
